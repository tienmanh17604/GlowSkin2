import { SKIN_TYPES, CONCERNS, CATEGORIES } from "../data/products";
...
export function getRecommendedProducts(productsList, analysisText, limit = 6) {
...
export function filterProducts(productsList, { skinType, category, concern }) {
